...
from ldivider.ld_utils import load_seg_model
...
# def divide_layer(divide_mode, input_image, mask_image, loops, init_cluster, ciede_threshold, blur_size, layer_mode, h_split, v_split, n_cluster, alpha, th_rate, split_bg, area_th):
...
#         return color_base_divide(input_image, mask_image, loops, init_cluster, ciede_threshold, blur_size, layer_mode, h_split, v_split, n_cluster, alpha, th_rate, split_bg)
...
# def color_base_divide(input_image, mask_image, loops, init_cluster, ciede_threshold, blur_size, layer_mode, h_split, v_split, n_cluster, alpha, th_rate, split_bg):
#     image = pil2cv(input_image)
#     input_image = cv2.cvtColor(image, cv2.COLOR_BGR2RGBA)

#     df = get_base(input_image, mask_image, loops, init_cluster, ciede_threshold, blur_size, h_split, v_split, n_cluster, alpha, th_rate, split_bg, False)
...
#         submit.click(
#             divide_layer,
#             inputs=[divide_mode, mask_image, input_image, loops, init_cluster, ciede_threshold, blur_size, layer_mode, h_split, v_split, n_cluster, alpha, th_rate, split_bg, area_th],
